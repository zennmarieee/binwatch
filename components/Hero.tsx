import { QrCode, Search, Workflow } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <h1 className="text-4xl font-black leading-tight tracking-[-0.02em] text-[#102013] sm:text-6xl">
        <span className="hero-brand-word">BinWatch</span> Smart Campus Waste
        Reporting
      </h1>
      <p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-[#4c616c] sm:text-lg">
        Scan a bin QR code, report in seconds, and help staff respond faster. No
        login needed. Student ID is optional for points.
      </p>
